...
while (coef_lengt_2 /8 != 1.0 || coef_lengt_2 /8 != 2.0 || coef_lengt_2 /8 != 3.0 || coef_lengt_2 /8 != 4.0 ||
     coef_lengt_2 /8 != 5.0 || coef_lengt_2 /8 != 6.0 || coef_lengt_2 /8 != 7.0 || coef_lengt_2 /8 != 8.0 ||
     coef_lengt_2 /8 != 9.0 || coef_lengt_2 /8 != 10.0 || coef_lengt_2 /8 != 11.0 || coef_lengt_2 /8 != 12.0)
{
  coef_lengt_2++;
  if
  (coef_lengt_2 /8 == 1.0 || coef_lengt_2 /8 == 2.0 || coef_lengt_2 /8 == 3.0 || coef_lengt_2 /8 == 4.0 ||
   coef_lengt_2 /8 == 5.0 || coef_lengt_2 /8 == 6.0 || coef_lengt_2 /8 == 7.0 || coef_lengt_2 /8 == 8.0 ||
   coef_lengt_2 /8 == 9.0 || coef_lengt_2 /8 == 10.0 || coef_lengt_2 /8 == 11.0 || coef_lengt_2 /8 == 12.0)
  {
    break;
...
{
  char coef_ascii [16] = {0};             // массив для буферизации каждого коэффициента
  i=0;
...
for (i_nulls=0; i_nulls < bank_num;)          // цикл для дозаписи нулей в конец файла
{
